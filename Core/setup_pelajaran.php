...
if(isset($_POST['submit'])){
	...
	if($query){
		?><script language="javascript">document.location.href="?page=setup_pelajaran&status=1";</script><?php
	}else{
		?><script language="javascript">document.location.href="?page=setup_pelajaran&status=2";</script><?php
	}
...
<tr>
    ...
    <div id="content-table-inner">
    		...
    		<form action="?page=setup_pelajaran" method="post">
 	        <table border="0" width="100%" cellpadding="0" cellspacing="0">
            <tr valign="top">
        ...
        <tr>
            ...
            <th width="68%" class="table-header-repeat line-left minwidth-1"><a href="">Nama Mata Pelajaran</a></th>
            <th width="16%" class="table-header-options line-left"><a href="">Aksi</a></th>
        </tr>
        
        
        <?php
		$view=mysql_query("select * from setup_pelajaran order by nama_pelajaran asc");
		...
		<tr>
            ...
            <a href="?page=edit_pelajaranf2&id=<?php echo $row['id_pelajaran']; ?>" title="Update Status" class="icon-5 info-tooltip"></a>            
            </td>
        </tr>
		<?php
		}
